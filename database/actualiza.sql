...
ALTER TABLE movies
RENAME COLUMN movieid
TO movie_id;

ALTER TABLE movies
RENAME COLUMN movietitle
TO title;
...
UPDATE movie_countries AS mc
SET country_id=c.country_id
FROM countries as c
WHERE mc.country=c.name;
...
UPDATE movie_genres AS mg
SET genre_id=g.genre_id
FROM genres as g
WHERE mg.genre=g.name;
...
UPDATE movie_languages AS ml
SET language_id=l.language_id
FROM languages as l
WHERE ml.language=l.name;
...
ALTER TABLE users
RENAME COLUMN customerid
TO user_id;

ALTER TABLE users
RENAME COLUMN address1
TO address;

ALTER TABLE users
RENAME COLUMN creditcard
TO bank_account;
...
-- Orders
ALTER TABLE orders
RENAME COLUMN orderid
TO order_id;

ALTER TABLE orders
RENAME COLUMN orderdate
TO date;
...
ALTER TABLE orders
RENAME COLUMN netamount
TO net_amount;

ALTER TABLE orders
RENAME COLUMN totalamount
TO total_amount;
